...
priors = g.nodes.match("Paradigms", name='Priors').first()
divergences = g.nodes.match("Paradigms", name="Divergences").first()
entanglement = g.nodes.match("Concepts", name="Entanglement").first()
misc = g.nodes.match("Information", name="misc").first()

vae = g.nodes.match("Frameworks", name='VAE').first()
gan = g.nodes.match("Frameworks", name="GAN").first()


list_of_terms = ['variational', 'adversarial', 'GAN', 'entangle', 'information', 'bottleneck', 'representation', 'understanding']
term2framework = {}
term2framework['variational'] = vae
term2framework['adversarial'] = gan
term2framework['GAN'] = gan
term2framework['entangle'] = entanglement
term2framework['information'] = misc
term2framework['representation'] = misc
term2framework['understanding'] = misc
term2framework['bottleneck'] = misc


framework2paradigm = {}
framework2paradigm[vae] = priors
framework2paradigm[gan] = divergences
framework2paradigm[entanglement] = None
framework2paradigm[misc] = None
