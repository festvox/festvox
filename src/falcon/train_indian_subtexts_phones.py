...
if __name__ == "__main__":
    ...
    X_train = SubTextDataSource('fnames.train', 'etc/falcon_feats.desc', feats_name, feats_name, charids, duration_dir)
    X_val = SubTextDataSource('fnames.val', 'etc/falcon_feats.desc', feats_name,  feats_name, charids, duration_dir)
