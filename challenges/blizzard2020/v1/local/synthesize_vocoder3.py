...
if __name__ == "__main__":
    ...
    with open(text_list_file_path, "rb") as f:
        ...
        for idx, line in enumerate(lines):
            ...
            quant_fname = vox_dir + '/festival/falcon_quant/' + fname + '.feats.npy'
            quant = np.load(quant_fname)
            assert len(quant) > 1
            coarse = quant // 256
            fine = quant % 256
            waveform = (coarse * 256 + fine) #/ 32767.5  - 1.0
