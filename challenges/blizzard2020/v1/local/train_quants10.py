"""Trainining script for Mandarin speech synthesis model. MoL for fine prediction
...
def train(model, train_loader, val_loader, optimizer,
    ...
    while global_epoch < nepochs:
        ...
        for step, (mel, coarse, coarse_float, fine, fine_float) in tqdm(enumerate(train_loader)):
            ...
            #print("Shapes of fine_logits and fine_targets: ", fine_logits.shape, fine_targets.shape)
            fine_loss = criterion_fine(fine_logits.transpose(1,2), fine_targets.unsqueeze(-1))
