"""Trainining script for Mandarin speech synthesis model. MoL for predicting quants
...
def train(model, train_loader, val_loader, optimizer,
    ...
    while global_epoch < nepochs:
        ...
        running_loss_fine_a = 0.
        running_loss_fine_b = 0.
