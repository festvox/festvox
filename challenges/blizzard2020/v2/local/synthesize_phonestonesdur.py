...
#from util import *
from model import DurationTonesAcousticModel as Tacotron
    ...
    with open(text_list_file_path, "rb") as f:
        ...
        for idx, line in enumerate(lines):
            ...
            for l in h:
                l = l.split('\n')[0].split()
            #l = ['0'] + l + ['0']
            tones = np.array([toneids[k] for k in l])
            ...
            print("Length of phones, tones and durations: ", len(phones), len(tones) , len(durations))
            ...
            waveform, spectrogram = tts(model, phones, tones)
