...
if __name__ == "__main__":
    ...
    with open(text_list_file_path, "rb") as f:
        ...
        for idx, line in enumerate(lines):
            ...
            dst_wav_path = join(dst_dir, "{}{}.wav".format('ARA_NORM_' + fname + '_synthesized', file_name_suffix))
            dst_alignment_path = join(dst_dir, "{}_alignment.png".format('ARA_NORM_' + fname + '_synthesized'))
