...
#from model import TacotronOneLSTMsBlockEncoder as Tacotron
        ...
        for step, (x, input_lengths, mel, y) in tqdm(enumerate(train_loader)):
            ...
            if global_step > 0 and global_step % hparams.save_states_interval == 0:
                save_states(
                    ...
                    None, checkpoint_dir, assistant=assistant)
            ...
            if use_assistant and assistant is not None:
              ...
              assistant.log_scalar("Learning rate", current_lr)
              assistant.log_scalar("Gradient Norm", grad_norm)
...
if __name__ == "__main__":
    ...
    try:
        train(model, train_loader, val_loader, optimizer,
              ...
              clip_thresh=hparams.clip_thresh,assistant=assistant)
