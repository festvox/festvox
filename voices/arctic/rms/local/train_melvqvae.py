...
from util import *
from model import MelVQVAEBaseline as Tacotron
...
def train(model, train_loader, val_loader, optimizer,
    ...
    while global_epoch < nepochs:
        ...
        for step, ( mel) in tqdm(enumerate(train_loader)):
            ...
            mel_outputs, attn, vq_penalty, encoder_penalty, entropy = model(mel)
            ...
            loss = mel_loss + vq_penalty + encoder_penalty #* encoder_weight
...
if __name__ == "__main__":
    ...
    trainset = MelVqVAEDataset(Mel_train)
    train_loader = data_utils.DataLoader(
        trainset, batch_size=hparams.batch_size,
        num_workers=hparams.num_workers, shuffle=True,
        collate_fn=collate_fn_melvqvae, pin_memory=hparams.pin_memory)

    valset = MelVqVAEDataset(Mel_val)
