...
from util import *
from model import TacotronOneSeqwiseMultispeakerStress as Tacotron
...
if __name__ == "__main__":
    ...
    stress_ids = defaultdict(lambda: len(stress_ids))
    stress_ids['0.0']
    stress_ids['1.0']
    ...
    feats_name = 'stress'
    Xstress_train = categorical_datasource( vox_dir + '/' + 'fnames.train', vox_dir + '/' + 'etc/falcon_feats.desc', feats_name, vox_dir + '/' +  'festival/falcon_' + feats_name, ph_ids, stress_ids)
