...
def tts(model, text, mel):
    ...
    mel_outputs, linear_outputs, alignments = model.forward_generate_gst(sequence, mel)
...
if __name__ == "__main__":
    ...
    with open(text_list_file_path, "rb") as f:
        ...
        for idx, line in enumerate(lines):
            ...
            mel_fname = 'vox/festival/falcon_mspec/' + fname + '.feats.npy'
            ...
            waveform, alignment, _ = tts(model, text, mel)
